 ...
 * Slightly modified by Matias Korhonen 2009
	...
	$.fn.resultStyle = "";
	 ...
	 $.fn.passStrength = function(options) {  
		 ...
		 var defaults = {
				...
				userid:			"user_username",				//required override
		 	...
		 	return this.each(function() { 
		 		...
		 		$(obj).unbind().keyup(function()
		 		{
					...
					else
					{
						...
						$(this).before("<span class=\""+opts.baseStyle+"\"></span>");
						$(this).prev("." + opts.baseStyle).addClass($(this).resultStyle).text(results);
					}
		 		 });
